...
extern struct window_params PARENT_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params SIMPLE_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params ADVANCED_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params COLLECTION_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params OPTIONS_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params DEBUG_MENU_DEFAULT_WINDOW_PARAMS;
extern struct window_params SCROLL_BOX_DEFAULT_WINDOW_PARAMS;
extern struct window_params DIALOGUE_BOX_DEFAULT_WINDOW_PARAMS;
extern struct window_params PORTRAIT_BOX_DEFAULT_WINDOW_PARAMS;
extern struct window_params TEXT_BOX_DEFAULT_WINDOW_PARAMS;
extern struct window_params AREA_NAME_BOX_DEFAULT_WINDOW_PARAMS;
extern struct window_params CONTROLS_CHART_DEFAULT_WINDOW_PARAMS;
...
extern int16_t UNKNOWN_PP_BOOST_AMOUNT;
...
extern int16_t MULTITALENT_PP_BOOST_AMOUNT;
...
extern int16_t EXCLUSIVE_ITEM_PP_BOOST_AMOUNT;
extern fx32_8 DAMAGE_FORMULA_FLV_SHIFT;
extern int16_t EVOLUTION_PHYSICAL_STAT_BONUSES[2];
extern fx32_8 DAMAGE_FORMULA_CONSTANT_SHIFT;
extern fx32_8 DAMAGE_FORMULA_FLV_DEFICIT_DIVISOR;
extern int16_t EGG_STAT_BONUSES[4];
extern int16_t EVOLUTION_SPECIAL_STAT_BONUSES[2];
extern fx32_8 DAMAGE_FORMULA_NON_TEAM_MEMBER_MODIFIER;
extern fx32_8 DAMAGE_FORMULA_LN_PREFACTOR;
...
extern undefined* MISSION_VALIDATION_FUNCTION_LIST[8];
...
extern struct window_params JOB_WINDOW_PARAMS_1;
extern struct simple_menu_id_item JOB_MENU_ITEMS_1[4];
extern struct simple_menu_id_item JOB_MENU_ITEMS_2[4];
extern struct simple_menu_id_item JOB_MENU_ITEMS_3[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_4[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_5[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_6[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_7[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_8[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_9[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_10[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_11[3];
extern struct simple_menu_id_item JOB_MENU_ITEMS_12[4];
extern struct simple_menu_id_item JOB_MENU_ITEMS_13[4];
...
extern fx16_14 FX_ATAN_IDX_TABLE[129];
extern int16_t TEX_PLTT_START_ADDR_TABLE[8];
extern int16_t TEX_START_ADDR_TABLE[48];
...
extern int MT_TABLE_INDEX;
extern int MT_LOW_BIT_MULTS[2];
extern int MERSENNE_TWISTER_TABLE[624];
